      ...
      >
        ...
        {variant === "landing" ? (
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/"
              className="text-ink-muted transition-colors hover:text-ink flex items-center justify-center p-1.5 rounded hover:bg-gold-tint"
              title="Back to site"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="transition-transform duration-200 hover:scale-105">
